 ...
 */
include_once 'config/papiUtils_phppoa2.php';
...
if ($assertion['PAPIAuthValue'] == 0 || !isset($_REQUEST['selector_name'])) {
    ...
    $client = new OAuth();
    $oauth_as = "https://oauth-server.rediris.es/oauth2_11/oauth_as/tokenEndpoint.php";
    $oauth_rs = "https://oauth-server.rediris.es/oauth2_11/oauth_server/serverEndpoint.php";
